...
function PrivacyPolicy() {
  return (
    <main className="page page--privacy-policy">
      <Section contain enableGutter>
        <Heading headingLevel="h1" fontSize={{ all: '5.6rem' }} fontWeight={700}>
          Privacy Policy
        </Heading>
        <br />
        <Text fontSize="1.4rem">Last updated: Sept 27, 2023</Text>
        <br />
        <Text>
          We value your privacy very highly. Please read this Privacy Policy carefully before using
          the https://dev.miguelangel.pro/ Website (the "Website") operated by Miguel Ángel ("us,"
          "we," "our") as this Privacy Policy contains important information regarding your privacy
          and how we may use the information we collect about you.
        </Text>
        <br />
        <Text>
        ...
        <Heading headingLevel="h4" fontSize={{ all: '2.4rem' }} fontWeight={700}>
          What information we collect, where we get this information, how we use this information,
          what happens if we don't have it, and the legal basis for processing this information
        </Heading>
        <br />
        <Text>
        ...
        <br />
        <Heading headingLevel="h5" fontSize={{ all: '2rem' }} fontWeight={700}>
          1. Identifying information - Name
        </Heading>
        <br />
        <Heading headingLevel="h6" fontSize={{ all: '2rem' }} fontWeight={400}>
        ...
        <br />
        <Text>We do not share your personal information with any third parties.</Text>
        <br />
        <Heading headingLevel="h4" fontSize={{ all: '2.4rem' }} fontWeight={700}>
        ...
        <Text>
          ...
          browser. This Website collects cookies and may use cookies for reasons including, but not
          limited to:
        </Text>
        <br />
        <ul>
        ...
        <Text>
          ...
          settings to decline cookies, if you prefer. This setting may prevent you from taking full
        ...
        <br />
        <Text>
          This Website uses different technologies for gathering Analytics information, such as, but
          not only, Google Analytics to collect information about you and your behaviors. If you
          would like to opt out of Google Analytics, please visit
        ...
        <br />
        <Text>
          We retain all of the information that we collect until we don't need it anymore to contact
          you or you request its removal.
        </Text>
        <br />
        <Heading headingLevel="h4" fontSize={{ all: '2.4rem' }} fontWeight={700}>
          Direct marketing
        ...
        <br />
        <Text>
          We use the information that we collect about you for direct marketing purposes. Direct
        ...
        <Text>
          ...
          identity, you will need to provide us with the following information with your request:
        </Text>
        <br />
        <ul>
          <li>Name</li>
        ...
        <br />
        <Text>
          Please note that we may be unable to process your request if you do not provide us with
          the above information. We will respond to most consumer requests within 30 to 45 days of
          receipt, depending upon where you reside. However, some requests may take longer. We will
          notify you in writing if we need more time to respond. We have the ability to deny your
          request(s) if certain exceptions in the law apply. If we do deny your request, we will
          provide you with the reasons for such denial.
        </Text>
        <br />
        <Heading headingLevel="h4" fontSize={{ all: '2.4rem' }} fontWeight={700}>
          Accountability
        ...
        <Text>
          ...
          our privacy practices and procedures at the contact information above.
        </Text>
        <br />
        <Heading headingLevel="h4" fontSize={{ all: '2.4rem' }} fontWeight={700}>
        ...
        <br />
        <Text>
          We transfer data from and outside of the United States. This means that your information
          may be processed in a country outside of the United States and it may be accessible to law
          enforcement authorities and national security authorities of the respective country and
          jurisdiction.
        </Text>
        <br />
        <Heading headingLevel="h4" fontSize={{ all: '2.4rem' }} fontWeight={700}>
        ...
        <br />
        <Text>
          We reserve the right to amend this Privacy Policy at any time. We will not provide you
          with any notice when we make changes to this Privacy Policy.
        </Text>
        <br />
        <Heading headingLevel="h4" fontSize={{ all: '2.4rem' }} fontWeight={700}>
          Questions
