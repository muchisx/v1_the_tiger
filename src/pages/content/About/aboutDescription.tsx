    ...
    rightTexts: [
      {
        ...
        children: (
          <>
            ...
            work with an acute attention to detail and aesthetics. This background allows me to
            create visually stunning websites that not only function flawlessly but also engage and
            captivate users.
            <br />
            <br />
            <Link to={EXTERNAL_URL.scheduler} target="_blank" rel="noopener noreferrer">
      ...
      },
      {
        ...
        children: (
          <>
            Beyond development, I offer valuable services such as Website Audits and Consultations,
            empowering companies to enhance their online presence strategically. Collaboration and
            partnership are at the heart of my approach. I collaborate closely with clients,
            maintaining transparency and honesty in every aspect of our work, ensuring that the
            solutions I provide align with their objectives.
            <br />
            <br />
            In a world where cutting corners is all too common, I stand as a firm advocate for
            excellence. Partner with me, and together, we can turn your digital aspirations into
            realities that not only meet but exceed your expectations, while always keeping an eye
            on quality as our guiding principle.
          </>
        ),
      },
    ],
